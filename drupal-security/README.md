# Claude Code Skill — drupal-security

> Claude Code skill — Sécurité Drupal : XSS, CSRF, accès, SQL injection, uploads, audit (D8-D11+)

## Installation

```bash
git clone https://github.com/ThomasRoger76/drupal-security ~/.claude/skills/drupal-security
```
...
```bash
cd ~/.claude/skills/drupal-security && git pull
```
